<template>
 ...
 <button class="subBtn" style="width:43%;padding:0;margin:20px 22px 20px 0px;float:right;box-sizing:border-box;"slot="apply" @click="goFillData">派单</button>
   ...
   getParams(){
      ...
      ,goFillData() {
       ...
       let config = {
        ...
        axios.post('/api/ospworkorder/opsworkorder/interface/updata?id='+this.id+'&state=2').then(response=> {
