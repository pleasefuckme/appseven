<template>
  <div class="container">
    <topComponent :title='appName' :showLeft='false'>
    	<span class="back" @click="$router.push('/loan/接单列表')" slot="left">返回
    	</span>
    </topComponent>
  ...
  export default {
   ...
   mounted:function(){
    ...
    methods: {
      getDp: function () {
      	var id="";
        axios.post('/api/ospworkorder/opsworkorder/interface/workorder?state=4&id='+id).then(response => {
