<template>
 ...
 <button class="subBtn" style="width:90%;padding:0;margin:20px 0px 20px 20px;float:left;box-sizing:border-box;"slot="apply" @click="getAppinfo(this.eqid)">设备信息</button>
 <!-- <button class="subBtn" style="width:43%;padding:0;margin:20px 22px 20px 0px;float:right;box-sizing:border-box;"slot="apply" @click="goFillData">处理完毕</button> -->
...
//               }
//             }
//         axios.post('/api/ospworkorder/opsworkorder/interface/updata?id='+this.id+'&state=4').then(response=> {
// 			        	if(response.data!=0&&response.data.success==true){
// 			        	//console.log(response.data.success)	;
// //			        	console.log(response.data)	
// //			        	 	console.log(response);	
// 			        	this.$dialog(['处理完毕待审核', 'true']);
